...
public class HeavySlash extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(HeavySlash.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public HeavySlash() { // - This one and the one right under the imports are the most important ones, don't forget them
