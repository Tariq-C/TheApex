...
public class Ambush extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(Ambush.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public Ambush() { // - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(p, p, new EnergizedPower(p , magicNumber))
        );
    }
