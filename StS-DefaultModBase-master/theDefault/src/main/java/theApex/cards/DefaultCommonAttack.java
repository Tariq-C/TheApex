...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = TheApexMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // Go check out DefaultAttackWithVariable and theApex.variable.DefaultCustomVariable
