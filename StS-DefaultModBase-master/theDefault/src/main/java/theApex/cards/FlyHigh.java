...
public class FlyHigh extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(FlyHigh.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public FlyHigh() { // - This one and the one right under the imports are the most important ones, don't forget them
