...
public class Overexert extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(Overexert.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    private static final int MINUS_DRAW = -2;
    private static final int UPG_DRAW = 1;

    // /STAT DECLARATION/


    public Overexert() { // - This one and the one right under the imports are the most important ones, don't forget them
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);
        baseMagicNumber = magicNumber = MINUS_DRAW;
    }
