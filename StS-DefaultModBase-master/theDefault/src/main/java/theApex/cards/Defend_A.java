...
public class Defend_A extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(Defend_A.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public Defend_A() { // - This one and the one right under the imports are the most important ones, don't forget them
