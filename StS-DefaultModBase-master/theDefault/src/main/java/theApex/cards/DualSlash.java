...
public class DualSlash extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(DualSlash.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    private static final int UPGRADE_PLUS_DMG = 2;  // UPGRADE_PLUS_DMG = 5
    ...
    public DualSlash() { // - This one and the one right under the imports are the most important ones, don't forget them
