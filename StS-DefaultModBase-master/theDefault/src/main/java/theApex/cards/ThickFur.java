...
public class ThickFur extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(ThickFur.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public ThickFur() { // - This one and the one right under the imports are the most important ones, don't forget them
