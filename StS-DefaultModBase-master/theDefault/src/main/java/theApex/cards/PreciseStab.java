...
public class PreciseStab extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(PreciseStab.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = TheApexMod.makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("SplinterArrow.png");
    ...
    private static final int BLEED_INC = 1;

    // /STAT DECLARATION/


    public PreciseStab() { // - This one and the one right under the imports are the most important ones, don't forget them
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
        baseMagicNumber = magicNumber = BLEED;
    }
