...
public class FireArrow extends AbstractDynamicCard {
    ...
    public static final String ID = TheApexMod.makeID(FireArrow.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("FireArrow.png");// "public static final String IMG = makeCardPath("SplinterArrow.png");
